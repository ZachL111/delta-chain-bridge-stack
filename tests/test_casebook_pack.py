"""Regression checks for the delta-chain-bridge-stack casebook."""
...
from casebook.harness import assert_expected, delta_chain_bridge_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(delta_chain_bridge_stack_summary(), assert_expected())
